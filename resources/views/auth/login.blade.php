              ...
              <div class="mb-3 form-password-toggle">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" name="password" id="password"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    class="form-control @error('password') is-invalid @enderror" aria-describedby="password" required
                ...
                <div class="mb-3">
                  ...
                  <div class="col-12 col-lg-6">
                    ...
                    <input type="text" name="captcha" id="captcha" placeholder=""
                      class=" mt-2 form-control form-control-sm @error('captcha') is-invalid @enderror" required />
                    @error('captcha')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
